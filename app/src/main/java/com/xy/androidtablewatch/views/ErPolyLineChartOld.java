...
public class ErPolyLineChartOld extends View {
    ...
    public ErPolyLineChartOld(Context context) {
        this(context, null);
    }

    public ErPolyLineChartOld(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < index; i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.er_polylinechart_er_mincircleColor:
                    ...
                    break;
                case R.styleable.er_polylinechart_er_tableType:
                    mDrawType = array.getString(attr);
                    Log.d("ernest", "mDrawType:" + mDrawType);
                    break;
            }
        }
        // 记得释放资源
