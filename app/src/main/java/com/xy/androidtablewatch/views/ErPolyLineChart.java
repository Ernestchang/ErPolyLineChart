 ...
 *  ernest
 */
public class ErPolyLineChart extends View {
...
//    private String mDrawType;
    ...
    public ErPolyLineChart(Context context) {
        this(context, null);
    }

    public ErPolyLineChart(Context context, AttributeSet attrs) {
...
//                    : value[i] + "";
            String text = value[i] / 1000f > 1 ? String.format("%.1f", value[i] / 1000f) + "k" : value[i] + "";
